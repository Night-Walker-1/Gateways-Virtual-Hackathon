...
exports.generateAdvancedCBTResponse = exports.generateCBTResponse = void 0;
const cbtTechniques = [
    {
...
const addToConversationHistory = (userId, message, response) => {
...
const getCopingStrategy = (technique) => {
    const strategies = {
        'anxiety': [
...
const generateCBTResponse = async (message, sentimentScore, userId) => {
...
exports.generateCBTResponse = generateCBTResponse;
// Advanced version that would integrate with OpenAI GPT
const generateAdvancedCBTResponse = async (message, sentimentScore, conversationHistory, userId) => {
    // This would integrate with OpenAI API in production
    // For now, return the enhanced CBT response
    return (0, exports.generateCBTResponse)(message, sentimentScore, userId);
};
exports.generateAdvancedCBTResponse = generateAdvancedCBTResponse;
